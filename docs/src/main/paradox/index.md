 ...
 * @ref[akka-cluster-bootstrap](bootstrap/index.md) helps bootstrapping an Akka cluster using @extref:[Akka Discovery](akka-docs:discovery/index.html).
 ...
 * @extref[Akka's built-in JMX management support](akka-docs:scala/cluster-usage.html#cluster-jmx) provides JMX MBeans for cluster management.
 ...
 As well as @extref:[Akka Discovery](akka-docs:discovery/index.html) methods for:
