...
* A working demo app is available in the [integration-test](https://github.com/akka/akka-management/tree/main/integration-test/aws-api-ec2)
folder.
...
* A working demo app is available in the
  [integration-test](https://github.com/akka/akka-management/tree/main/integration-test/aws-api-ecs)
