...
import akka.discovery.awsapi.ecs.AsyncEcsTagBasedServiceDiscovery._
...
class AsyncEcsTagBasedServiceDiscovery(system: ActorSystem) extends ServiceDiscovery {
  ...
  private[this] val config = system.settings.config.getConfig("akka.discovery.aws-api-ecs-tag-based-async")
...
@ApiMayChange
object AsyncEcsTagBasedServiceDiscovery {
