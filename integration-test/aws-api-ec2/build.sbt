...
libraryDependencies += "com.amazonaws" % "aws-java-sdk-cloudformation" % "1.12.321" % IntegrationTest

libraryDependencies += "com.amazonaws" % "aws-java-sdk-autoscaling" % "1.12.321" % IntegrationTest
