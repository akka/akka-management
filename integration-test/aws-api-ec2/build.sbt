...
libraryDependencies += "com.amazonaws" % "aws-java-sdk-cloudformation" % "1.11.1013" % IntegrationTest

libraryDependencies += "com.amazonaws" % "aws-java-sdk-autoscaling" % "1.11.1013" % IntegrationTest
