...
libraryDependencies += "com.amazonaws" % "aws-java-sdk-cloudformation" % "1.11.856" % IntegrationTest

libraryDependencies += "com.amazonaws" % "aws-java-sdk-autoscaling" % "1.11.856" % IntegrationTest
